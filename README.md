...
项目已有较详细的 [项目搭建文档](https://www.yuque.com/yuqueyonghuwukmla/agvbv6/sf5yutsd8kikr7z7) ，同时包括了 **Windows**、**Linux** 以及 **Docker** 环境下暹罗外卖的搭建。在使用过程中遇到问题时，首先认真阅读**项目搭建文档**~
...
文档地址：https://www.yuque.com/yuqueyonghuwukmla/agvbv6/sf5yutsd8kikr7z7
