...
import com.siam.package_feign.mod_feign.order.OrderDetailFeignClient;
...
import com.siam.package_goods.GoodsApplication;
...
//        String passwordSalt = CommonUtils.genSalt();
    ...
    public void testConsume(){
        List<OrderDetail> orderDetailList = orderDetailFeignClient.selectByOrderId(151);
