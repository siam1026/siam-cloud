...
import com.siam.package_order.feign.OrderDetailFeignApi;
...
public class GoodsApplicationTest {
    ...
    @Autowired
    private OrderDetailFeignApi orderDetailFeignApi;
...
//        String passwordSalt = CommonUtils.genSalt();
    ...
    public void testPublicPlatformOpenId() throws IOException {
        ...
        for (String key : filterMap.keySet()){
            ...
            memberParam.setUsername(nickname);
            List<Member> memberList = memberFeignApi.selectByExample(memberParam).getData();
            if(memberList == null){
                repeatNumber_member++;
