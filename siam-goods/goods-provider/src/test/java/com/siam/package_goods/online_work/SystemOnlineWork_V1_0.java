package com.siam.package_goods.online_work;
...
public class SystemOnlineWork_V1_0 {
    ...
    public void test(){
        ...
        for (Goods goods : allGoodsList) {
            ...
            couponsGoodsRelationFeignApi.insertSelective(newPeopleCouponsGoodsRelation);
            ...
            couponsGoodsRelationFeignApi.insertSelective(inviteNewPeopleCouponsGoodsRelation);
        }
    }*/
}