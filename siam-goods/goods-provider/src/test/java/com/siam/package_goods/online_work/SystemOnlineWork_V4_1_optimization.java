...
//
//    @Autowired
//    private com.siam.package_goods.service.AdvertisementService advertisementService;
//
//    @Autowired
...
//        com.siam.package_goods.entity.Advertisement advertisement = new com.siam.package_goods.entity.Advertisement();
//        advertisement.setType(Quantity.INT_4);
//        Page<com.siam.package_goods.entity.Advertisement> page = advertisementService.getListByPage(new Page(pageNo, pageSize), -1, 10, advertisement);
//
//        List<com.siam.package_user.entity.Member> memberList = memberService.selectByExample(new com.siam.package_user.model.example.MemberExample());
