...
//
//    @Autowired
//    private com.siam.package_goods.service.OrderService orderService;
//
//    @Autowired
//    private com.siam.package_goods.service.ShopService shopService;
//
//    @Autowired
...
//        List<com.siam.package_goods.entity.Goods> goodsList = goodsService.selectByExample(new com.siam.package_goods.model.example.GoodsExample());
//        goodsList.forEach(goods -> {
//            com.siam.package_goods.entity.Goods updateGoods = new com.siam.package_goods.entity.Goods();
...
//        List<com.siam.package_goods.entity.Order> orderList = orderService.selectByExample(new com.siam.package_goods.model.example.OrderExample());
//        orderList.forEach(order -> {
//            com.siam.package_goods.entity.Shop shop = shopService.selectByPrimaryKey(order.getShopId());
//            com.siam.package_goods.entity.Order updateOrder = new com.siam.package_goods.entity.Order();
