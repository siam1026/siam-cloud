...
//    @Autowired
//    private com.siam.package_goods.service.PointsMallOrderService orderService;
//
//    @Autowired
//    private com.siam.package_common.service.AliyunSms aliyunSms;
//
//    @Autowired
//    private com.siam.package_goods.service.PointsMallOrderRefundService orderRefundService;
//
//    @Autowired
//    private com.siam.package_goods.service.PointsMallOrderRefundGoodsService orderRefundGoodsService;
//
//    @Autowired
//    private com.siam.package_goods.service.PointsMallOrderRefundProcessService orderRefundProcessService;
//
//    @Autowired
...
//
//    @Autowired
//    private com.siam.package_goods.service.PointsMallOrderLogisticsService orderLogisticsService;
//
//    @Autowired
//    private com.siam.package_goods.service.PointsMallOrderDetailService orderDetailService;
//
//    @Autowired
//    private com.siam.package_goods.service.PointsMallCouponsMemberRelationService couponsMemberRelationService;
//
//    @Test
//    public void work() {
//        //纠正错误的积分商城退款订单
...
//            com.siam.package_goods.entity.PointsMallOrder dbPointsMallOrder = orderService.selectByPrimaryKey(id);
//            if (dbPointsMallOrder == null) throw new StoneCustomerException("该订单不存在");
//
//            com.siam.package_goods.entity.PointsMallOrderRefund dbPointsMallOrderRefund = orderRefundService.selectByPointsMallOrderId(id);
...
//
//            //修改订单记录状态-售后处理完成
//            com.siam.package_goods.entity.PointsMallOrder updatePointsMallOrder = new com.siam.package_goods.entity.PointsMallOrder();
...
//
//            //修改退款状态 -- 退款成功
//            com.siam.package_goods.entity.PointsMallOrderRefund updatePointsMallOrderRefund = new com.siam.package_goods.entity.PointsMallOrderRefund();
...
//
//            //添加退款流程 -- 等待平台处理
//            com.siam.package_goods.entity.PointsMallOrderRefundProcess orderRefundProcess = new com.siam.package_goods.entity.PointsMallOrderRefundProcess();
...
//
//            //添加退款流程 -- 退款成功
//            com.siam.package_goods.entity.PointsMallOrderRefundProcess orderRefundProcess_second = new com.siam.package_goods.entity.PointsMallOrderRefundProcess();
...
//            com.siam.package_goods.model.example.MemberBillingRecordExample example = new com.siam.package_goods.model.example.MemberBillingRecordExample();
