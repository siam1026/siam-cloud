...
public class AdminGoodsController {
    ...
    public BasicResult insert(@RequestBody @Validated(value = {}) GoodsMenuDto param){
        ...
        couponsGoodsRelationFeignApi.insertSelective(insertCouponsGoodsRelation);
        ...
        couponsGoodsRelationFeignApi.insertSelective(insertCouponsGoodsRelationInvite);
    ...
    public BasicResult update(@RequestBody @Validated(value = {}) GoodsMenuDto param){
        ...
        // 修改商品信息
        param.setUpdateTime(new Date());
        goodsService.updateByPrimaryKeySelective(param);
