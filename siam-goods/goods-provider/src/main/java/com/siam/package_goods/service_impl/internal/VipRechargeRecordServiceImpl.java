...
import com.siam.package_goods.entity.internal.VipRechargeDenominationCouponsRelation;
import com.siam.package_goods.entity.internal.VipRechargeRecord;
import com.siam.package_goods.mapper.internal.VipRechargeRecordMapper;
import com.siam.package_goods.service.*;
import com.siam.package_common.constant.Quantity;
import com.siam.package_common.exception.StoneCustomerException;
import com.siam.package_common.util.GsonUtils;
import com.siam.package_goods.model.example.internal.VipRechargeDenominationCouponsRelationExample;
import com.siam.package_goods.service.internal.VipRechargeDenominationCouponsRelationService;
...
public class VipRechargeRecordServiceImpl implements VipRechargeRecordService {
    ...
    public void updateByPayNotify(String outTradeNo) {
        ...
        Member dbMember = memberFeignClient.selectByPrimaryKey(dbVipRechargeRecord.getMemberId());
        if(dbMember == null){
        ...
        if(dbMember.getType().equals(Quantity.INT_1)){
            ...
            dbMember = memberFeignClient.selectByPrimaryKey(dbVipRechargeRecord.getMemberId());
        }
