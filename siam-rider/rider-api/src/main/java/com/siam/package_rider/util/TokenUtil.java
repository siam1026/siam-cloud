package com.siam.package_rider.util;
...
public class TokenUtil {
     ...
     * @author 暹罗
     */
    public static String generateToken(Rider rider) {
        String token = "";
        token = JWT.create().withAudience(rider.getId().toString())
                .sign(Algorithm.HMAC256(rider.getPassword()));
        return token;
    }
