...
<template>
	<section>
      ...
      <el-table-column prop="status" label="订单状态" width="100" :formatter="formatOrder"></el-table-column>
          ...
          <!-- <el-button size="small" @click="handleEdit(scope.row)">标记配送</el-button> -->
          <el-button size="small" @click="handleEdit(scope.row)">开始配送</el-button>
	...
	export default {
      ...
      formatOrder (row, column) { // 0-待配送 1-待收货 2已完成 3-已取消 4-申诉中 5-已退款 6-申诉已完成
        ...
        vue.listLoading = true;
				vue.$http.post(vue, '/api-order/rest/merchant/order/list', param,
					(vue, data) => {
        ...
        let param = {
          ...
          flag: 3
				...
				vue.$http.post(vue, '/api-order/rest/merchant/order/updateStatus', param,
					function(vue, data) {
            vue.$message({
              showClose: true,
              message: data.message,
