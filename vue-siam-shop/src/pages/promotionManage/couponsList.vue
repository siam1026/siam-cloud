	...
	export default {
		...
		methods: {
			...
			getList(pageNoParam) { // 获取列表
				...
				vue.$http.post(vue, '/api-promotion/rest/merchant/coupons/list', param,
					(vue, data) => {
			...
			handleDel (id) { // 删除
				this.$confirm('确认删除该记录吗?', '提示', {
					...
					vue.$http.delete(vue, '/api-promotion/rest/merchant/coupons/delete', {"id" : id},
						function(vue, data) {
							vue.$message({
								showClose: true,
								message: data.message,
			...
			handleGiveCoupons (id) { // 派发优惠券
					let vue = this;
					vue.$http.post(vue, '/api-promotion/rest/merchant/couponsMemberRelation/giveCoupons', {"couponsId" : id},
						function(vue, data) {
							vue.$message({
								showClose: true,
								message: data.message,
			...
			editSubmit: function () { // 编辑
				this.$refs.editForm.validate((valid) => {
					if (valid) {						
						...
						if(param.id){
							url = '/api-promotion/rest/merchant/coupons/update';
							...
							url = '/api-promotion/rest/merchant/coupons/insert';
							vue.$http.post(vue, url, param,
								(vue, data) => {
									// this.editLoading = false;
									vue.$message({
			...
			handleRelationGoods (id) { // 关联商品
				...
				let vue = this
				vue.$http.post(vue, '/api-promotion/rest/merchant/coupons/selectById', {"id" : id},
					(vue, data) => {
