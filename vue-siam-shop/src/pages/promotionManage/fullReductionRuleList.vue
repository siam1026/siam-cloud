	...
	export default {
		...
		methods: {
			...
			handleCurrentChange(val) {
				...
				vue.$http.post(vue, '/api-goods/rest/merchant/fullReductionRule/list', param,
					(vue, data) => {
			...
			handleDel (id) { // 删除
				this.$confirm('确认删除该记录吗?', '提示', {
					...
					vue.$http.delete(vue, '/api-goods/rest/merchant/fullReductionRule/delete', {"id" : id},
						function(vue, data) {
							vue.$message({
								showClose: true,
								message: data.message,
			...
			editSubmit: function () { // 编辑
				this.$refs.editForm.validate((valid) => {
					if (valid) {						
						...
						if(param.id){
							url = '/api-goods/rest/merchant/fullReductionRule/update';
							...
							url = '/api-goods/rest/merchant/fullReductionRule/insert';
