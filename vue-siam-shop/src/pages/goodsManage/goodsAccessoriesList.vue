	...
	export default {
		...
		methods: {
			...
			getList(pageNoParam) { // 获取列表
				...
				vue.$http.post(vue, '/api-goods/rest/merchant/goodsAccessories/list', param,
					(vue, data) => {
			...
			handleDel (id) { // 删除
				this.$confirm('确认删除该记录吗?', '提示', {
					...
					vue.$http.delete(vue, '/api-goods/rest/merchant/goodsAccessories/delete', {"id" : id},
						function(vue, data) {
							vue.$message({
								showClose: true,
								message: data.message,
			...
			editSubmit: function () { // 编辑
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						...
						if(param.id){
							url = '/api-goods/rest/merchant/goodsAccessories/update';
							...
							url = '/api-goods/rest/merchant/goodsAccessories/insert';
