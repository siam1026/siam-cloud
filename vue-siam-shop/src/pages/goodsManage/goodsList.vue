	...
	export default {
      ...
      updateSpecification(item) {
        ...
        delete param.updateTime;
				vue.$http.post(vue, '/api-goods/rest/merchant/goodsSpecificationOption/update', param,
					function(vue, data) {
            vue.$message({
              showClose: true,
      ...
      removeSpecification(item) {
        ...
        // alert(JSON.stringify(item));
				vue.$http.post(vue, '/api-goods/rest/merchant/goodsSpecificationOption/delete', {"ids": [data.id]},
					function(vue, data) {
            vue.$message({
              showClose: true,
              message: data.message,
      ...
      addSpecification(row) { // 新增规格
        ...
        let url = ''
        param.id ? url = '/api-goods/rest/merchant/goodsSpecificationOption/update' : url = '/api-goods/rest/merchant/goodsSpecificationOption/insert'
      ...
      updateStatus(row, status=1) {
        ...
        this.$confirm('确认'+ NoticeTitle +' ‘ '+ row.name +' ’ ?', '提示', {
          ...
          vue.$http.post(vue, '/api-goods/rest/merchant/goods/update', param,
            function(vue, data) {
              vue.$message({
                showClose: true,
                message: data.message,
          ...
          $.ajax({
			...
			handleDel (id) { // 删除
				this.$confirm('确认删除该记录吗?', '提示', {
					...
					// this.listLoading = true;
				let vue = this;
				vue.$http.post(vue, '/api-goods/rest/merchant/goods/delete', {"id":id},
					function(vue, data) {
            vue.$message({
              showClose: true,
              message: data.message,
