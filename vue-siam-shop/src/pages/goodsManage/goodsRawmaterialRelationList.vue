	...
	export default {
		...
		methods: {
			...
			handleCurrentChange(val) {
				...
				vue.$http.post(vue, '/api-goods/rest/merchant/goodsRawmaterialRelation/find/goodsRawmaterialRelation', param,
					(vue, data) => {
			...
			handleDetail (goodsId) { // 查看原料配比详情，刷新右侧列表
				...
				vue.$http.post(vue, '/api-goods/rest/merchant/goodsRawmaterialRelation/find/goodsRawmaterialRelationByGoodsId', param,
					function(vue, data) {
			...
			handleDel (id) { // 删除
				this.$confirm('确认删除该记录吗?', '提示', {
					...
					let vue = this;
					vue.$http.delete(vue, '/api-goods/rest/merchant/goodsRawmaterialRelation/delete', {"id" : id},
						function(vue, data) {
							vue.$message({
								showClose: true,
								message: data.message,
			...
			editSubmit: function () { // 编辑
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						...
						url = '/api-goods/rest/merchant/goodsRawmaterialRelation/update';
			...
			getListRelationTable() { // 获取原料配比列表
				...
				vue.$http.post(vue, '/api-goods/rest/merchant/rawmaterial/list', param,
					(vue, data) => {
			...
			editSubmitRelationTable: function () { // 原料配比保存事件
				...
				url = '/api-goods/rest/merchant/goodsRawmaterialRelation/insert';
