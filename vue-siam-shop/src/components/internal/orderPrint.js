            ...
            get() {
                return {
                    ...
                    autoPrintOrderInfo() { // 获取订单列表      
                        ...
                        $.ajax({
                            type: "post",
                            url: urlPrefix + '/api-order/rest/merchant/order/waitPrintOrderList',
                            async: true,
                            data: {},
                    ...
                    printOrderDetail: function (id) {
                        ...
                        $.ajax({
                            type: "post",
                            url: urlPrefix + '/api-order/rest/merchant/order/selectById',
                            async: true,
                            data: {"id" : id},
                            beforeSend: function(request) {
                                request.setRequestHeader("token", sessionStorage.getItem("token"));
                            ...
                            success: function(data){
                                ...
                                $.ajax({
                                    type: "post",
                                    url: urlPrefix + '/api-order/rest/merchant/orderDetail/list',
                                    async: false,
