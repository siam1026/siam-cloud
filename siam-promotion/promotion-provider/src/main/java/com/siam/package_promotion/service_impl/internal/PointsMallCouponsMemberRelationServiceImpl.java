package com.siam.package_promotion.service_impl.internal;
...
import com.siam.package_promotion.mapper.internal.PointsMallCouponsMapper;
import com.siam.package_promotion.mapper.internal.PointsMallCouponsMemberRelationMapper;
import com.siam.package_promotion.service.internal.PointsMallCouponsMemberRelationService;
...
//    private MemberMapper memberMapper;
    ...
    public Page<Map<String, Object>> getListByPage(int pageNo, int pageSize, PointsMallCouponsMemberRelation couponsMemberRelation) {
        ...
        for (Map  couponsMemberRelationMap : page.getRecords()) {
            ...
            map.put("goodsList", pointsMallGoodsFeignApi.getListByPointsMallCouponsId((Integer) couponsMemberRelationMap.get("couponsId")).getData());
