...
import com.siam.package_promotion.mapper.CouponsMapper;
import com.siam.package_promotion.mapper.CouponsMemberRelationMapper;
...
//    private MemberMapper memberMapper;
    ...
    public Page<Map<String, Object>> getListByPage(int pageNo, int pageSize, CouponsMemberRelation couponsMemberRelation) {
        ...
        for (Map  couponsMemberRelationMap : page.getRecords()) {
            ...
            map.put("goodsList", goodsFeignApi.getListByCouponsId((Integer) couponsMemberRelationMap.get("couponsId")).getData());
            map.put("shopList", shopFeignApi.getListByCouponsId((Integer) couponsMemberRelationMap.get("couponsId")).getData());
            result.add(map);
        }
