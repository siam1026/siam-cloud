...
import com.siam.package_promotion.mapper.internal.PointsMallCouponsGoodsRelationMapper;
...
public class PointsMallCouponsServiceImpl implements PointsMallCouponsService {
    ...
    public Map selectCouponsAndGoodsByPrimaryKey(Integer id) {
        ...
        //2、查询对象对应的商品
        List<PointsMallGoods> goodsList = pointsMallGoodsFeignApi.getListByPointsMallCouponsId(id).getData();
