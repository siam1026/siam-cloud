...
import com.siam.package_promotion.mapper.CouponsGoodsRelationMapper;
...
public class CouponsServiceImpl implements CouponsService {
    ...
    public Map selectCouponsAndGoodsByPrimaryKey(Integer id) {
        ...
        //2、查询对象对应的商品
        List<Goods> goodsList = goodsFeignApi.getListByCouponsId(id).getData();

        //3、查询对象对应的店铺
        List<Shop> shopList = shopFeignApi.getListByCouponsId(id).getData();
