...
import com.siam.package_merchant.mapper.MerchantBillingRecordMapper;
import com.siam.package_merchant.mapper.MerchantMapper;
...
import com.siam.package_promotion.feign.CouponsShopRelationFeignApi;
...
//    }
    ...
    public MerchantResult registerByMobile(MerchantParam param) {
        ...
        if (dbMerchant != null) {
            ...
            int shopId = shopFeignApi.insertSelective(insertShop).getData();
            ...
            messageFeignApi.insertSelective(sysMessage);
    ...
    public MerchantResult getLoginMerchantInfo(MerchantParam param) {
        ...
        Shop shop = shopFeignApi.selectByPrimaryKey(dbMerchant.getShopId()).getData();
