...
public class MerchantWithdrawRecord {
    ...
    private Integer merchantTradeRecordId;
    ...
    public Integer getMerchantTradeRecordId() {
        return merchantTradeRecordId;
    }

    public void setMerchantTradeRecordId(Integer merchantTradeRecordId) {
        this.merchantTradeRecordId = merchantTradeRecordId;
    }
