...
Page({
  ...
  submitApplyRefund() {
    ...
    let url = "/api-order/rest/member/pointsMall/order/applyRefundUndelivered";
    if (this.data.refundJson.type == 1) {
      url = "/api-order/rest/member/pointsMall/order/applyAfterSalesDelivered/onlyRefund";
    }
    if (this.data.refundJson.type == 2) {
      url = "/api-order/rest/member/pointsMall/order/applyAfterSalesDelivered/returnGoodsWithRefund";
    }
