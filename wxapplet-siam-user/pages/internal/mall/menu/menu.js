...
Page({
   ...
   getMenuList() {
      ...
      var self = this;
      https.request('/api-goods/rest/pointsMall/menu/listWithGoods',{}).then(result => {
   ...
   insertShoppingCart(e) {
      ...
      authService.checkIsLogin().then(result => {
         ...
         if (result) {
            ...
            https.request('/api-goods/rest/member/pointsMall/shoppingCart/insert', data).then(result => {
               if (result.success) {
