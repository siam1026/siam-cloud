...
Page({
  ...
  //   https.request('/api-goods/rest/member/couponsMemberRelation/selectCounts').then(result => {
  //     if (result.success) {
  ...
  //   https.request('/api-goods/rest/member/pointsMall/couponsMemberRelation/selectCounts').then(result => {
  //     if (result.success) {
  //       this.setData({
