...
###运行镜像
# docker run -d -p 9601:9601 -p 9611:9041 --name siam-zuul -v /home/dockerdata/oap/volume/siam-zuul/apache-skywalking-apm-bin/:/opt/apache-skywalking-apm-bin/ siam-zuul:v1.0
