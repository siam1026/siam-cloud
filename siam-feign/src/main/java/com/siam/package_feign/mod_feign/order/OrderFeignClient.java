...
@FeignClient(value = "order-siam", path = "/rest/orderFeign")
public interface OrderFeignClient {
    ...
    Map countOrder(@RequestBody Order order);
    ...
    BigDecimal selectSumMerchantIncome(@RequestBody Order order);

    /**
     * 查询用户实际支付金额
     */
    @RequestMapping(value = "/selectSumActualPrice")
    BigDecimal selectSumActualPrice(@RequestBody Order order);

    /**
     * 查询支付订单数量
     */
    @RequestMapping(value = "/selectCountCompleted")
    int selectCountCompleted(@RequestBody Order order);

    /**
     * 查询支付订单数量
     */
    @RequestMapping(value = "/selectCountPaid")
    int selectCountPaid(@RequestBody Order order);

    @RequestMapping(value = "/selectCountUnCompleted")
    int selectCountUnCompleted(@RequestBody Order order);

    @RequestMapping(value = "/selectCountWaitHandle")
    int selectCountWaitHandle(@RequestBody Order order);

    @RequestMapping(value = "/selectSumField")
    Map<String, Object> selectSumField(@RequestBody Order order);

    @RequestMapping(value = "/countByExample")
    int countByExample(@RequestBody Order order);

    @RequestMapping(value = "/selectCountPayers")
    int selectCountPayers(@RequestBody Order order);

    @RequestMapping(value = "/selectCountOrderPeoples")
    int selectCountOrderPeoples(@RequestBody Order order);
}