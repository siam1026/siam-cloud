...
//    private MemberFeignClient memberFeignClient;
            ...
            if (trade_status.equals("TRADE_SUCCESS")){
                ...
                *//*String json = GsonUtils.toJson(dbOrder);
                ...
                for(OrderDetail orderDetail : list){
                    ...
                    goodsFeignClient.decreaseStock(Integer.valueOf(goodsId), number);

                    // 减少商品规格组合库存
                    String goodsSpecificationId = orderDetail.getGoodsSpecificationId();
                    goodsSpecificationFeignClient.decreaseStock(Integer.valueOf(goodsSpecificationId), number);
                }*//*
    ...
    public BasicResult orderPay(WxpayBean wxpayBean, HttpServletRequest request){
        ...
        //获取用户当前积分数
        Integer currentPointsNum = memberFeignClient.selectByPrimaryKey(dbOrder.getMemberId()).getPoints();
