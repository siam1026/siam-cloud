...
@RestController
@RequestMapping(value = "/rest/merchant/orderDetail")
@Transactional(rollbackFor = Exception.class)
@Tag(name = "商家端订单商品详情模块相关接口", description = "MerchantOrderDetailController")
...
//    @Operation(summary = "新增订单商品详情")
////    @PostMapping(value = "/insert")
//    public BasicResult insert(OrderDetail orderDetail){
...
//    }
//
//    @Operation(summary = "修改订单商品详情")
////    @PostMapping(value = "/update")
//    public BasicResult update(OrderDetail orderDetail){
//        BasicResult basicResult = new BasicResult();
//
...
//    }
//
//    @Operation(summary = "删除订单商品详情(含批量操作)")
