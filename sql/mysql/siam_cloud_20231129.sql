...
INSERT INTO `tb_coupons` VALUES ('51', '1', '1', '0.90', '0.00', '0.00', '1', '1', '2020-10-14 00:00:00', '2020-10-30 00:00:00', '0', '1', '1', '2020-10-14 16:44:49', '2020-10-14 16:45:51');
...
INSERT INTO `tb_coupons` VALUES ('60', 'wqwq', '1', '0.60', '0.00', '0.00', 'qwq', '2', null, null, '1', '1', '2', '2023-11-10 15:28:09', '2023-11-10 15:28:12');
...
CREATE TABLE `tb_coupons_member_relation` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19588 DEFAULT CHARSET=utf8 COMMENT='优惠卷用户关联表';
...
-- ----------------------------
INSERT INTO `tb_give_like` VALUES ('4', '203', '2', null, '1', '2021-04-24 14:02:02', null);
...
-- ----------------------------
-- Table structure for tb_goods_accessories
-- ----------------------------
DROP TABLE IF EXISTS `tb_goods_accessories`;
CREATE TABLE `tb_goods_accessories` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `name` varchar(50) NOT NULL COMMENT '辅料名称',
  `main_image` varchar(128) DEFAULT NULL COMMENT '辅料主图',
  `description` varchar(512) DEFAULT NULL COMMENT '辅料描述',
  `price` decimal(10,2) DEFAULT '0.00' COMMENT '单价',
  `stock` int(11) DEFAULT '1' COMMENT '库存 1=有货 2=无货',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='商品辅料表';

-- ----------------------------
-- Records of tb_goods_accessories
-- ----------------------------
INSERT INTO `tb_goods_accessories` VALUES ('36', '珍珠', null, null, '1.00', '1', '2020-01-02 10:59:19', '2020-03-15 20:37:50');
INSERT INTO `tb_goods_accessories` VALUES ('37', '椰果', null, null, '1.00', '1', '2020-02-17 19:04:44', '2020-03-15 20:23:24');
INSERT INTO `tb_goods_accessories` VALUES ('38', '红豆', null, null, '1.00', '1', '2020-03-15 20:38:06', '2020-03-15 20:38:06');
INSERT INTO `tb_goods_accessories` VALUES ('39', '花生', null, null, '1.00', '1', '2020-03-23 17:08:22', '2020-03-23 17:08:22');
INSERT INTO `tb_goods_accessories` VALUES ('40', '葡萄', null, null, '1.00', '1', '2020-03-23 17:08:30', '2020-03-23 17:08:30');
...
-- ----------------------------
-- Records of tb_goods_rawmaterial_relation
-- ----------------------------
INSERT INTO `tb_goods_rawmaterial_relation` VALUES ('25', '28', '44', '0.06', '2020-03-23 19:55:16', '2020-03-23 20:55:44');
INSERT INTO `tb_goods_rawmaterial_relation` VALUES ('26', '28', '43', '0.03', '2020-03-23 19:55:17', '2020-03-23 19:55:17');
INSERT INTO `tb_goods_rawmaterial_relation` VALUES ('31', '33', '44', '0.01', '2020-03-23 19:55:17', '2020-03-23 21:10:16');
INSERT INTO `tb_goods_rawmaterial_relation` VALUES ('32', '33', '43', '0.03', '2020-03-23 19:55:18', '2020-03-23 21:15:00');
INSERT INTO `tb_goods_rawmaterial_relation` VALUES ('36', '28', '45', '0.05', '2020-03-23 20:55:43', '2020-03-23 20:55:43');
INSERT INTO `tb_goods_rawmaterial_relation` VALUES ('37', '33', '45', '0.01', '2020-03-23 21:01:19', '2020-03-23 21:10:16');
INSERT INTO `tb_goods_rawmaterial_relation` VALUES ('43', '38', '49', '1.00', '2020-04-05 22:43:26', '2020-04-05 22:43:26');
INSERT INTO `tb_goods_rawmaterial_relation` VALUES ('44', '38', '48', '45.00', '2020-04-05 22:43:26', '2020-04-05 22:43:26');
...
CREATE TABLE `tb_member_billing_record` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=102 DEFAULT CHARSET=utf8 COMMENT='用户账单记录表';
...
CREATE TABLE `tb_member_trade_record` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3195 DEFAULT CHARSET=utf8 COMMENT='平台交易记录表';
...
CREATE TABLE `tb_merchant_billing_record` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=164 DEFAULT CHARSET=utf8 COMMENT='商家账单记录表';
...
CREATE TABLE `tb_order` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3518 DEFAULT CHARSET=utf8 COMMENT='订单表';
...
CREATE TABLE `tb_order_detail` (
  ...
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否删除 0=正常 1=删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4426 DEFAULT CHARSET=utf8 COMMENT='订单商品详情表';
...
-- ----------------------------
INSERT INTO `tb_rawmaterial` VALUES ('43', '凤庆红茶', null, null, '克', '45.0000000000', '-5.2600000000', '2.0000000000', '20.0000000000', '2020-03-23 11:32:11', '2020-03-23 17:02:53');
INSERT INTO `tb_rawmaterial` VALUES ('44', '鸡蛋布丁', null, null, '克', '35.0000000000', '-26.0000000000', '2.0000000000', '20.0000000000', '2020-03-23 11:58:10', '2020-03-23 17:02:47');
INSERT INTO `tb_rawmaterial` VALUES ('45', '白沙糖', null, null, '克', '0.0032500000', '9962.1300000000', '10000.0000000000', '20000.0000000000', '2020-03-23 12:00:37', '2020-03-24 10:59:50');
INSERT INTO `tb_rawmaterial` VALUES ('46', '蛋挞皮', null, null, '个', '0.4000000000', '56.0000000000', '100.0000000000', '2000.0000000000', '2020-04-05 22:33:30', '2020-04-08 11:09:52');
INSERT INTO `tb_rawmaterial` VALUES ('47', '蛋挞液', null, null, '克', '0.0129000000', '5680.0000000000', '3000.0000000000', '20000.0000000000', '2020-04-05 22:35:04', '2020-04-05 22:35:04');
INSERT INTO `tb_rawmaterial` VALUES ('48', '柠檬C', null, null, '克', '0.0120000000', '6600.0000000000', '5000.0000000000', '30000.0000000000', '2020-04-05 22:41:13', '2020-04-05 22:41:13');
INSERT INTO `tb_rawmaterial` VALUES ('49', '鲜柠檬片', null, null, '片', '0.0500000000', '380.0000000000', '300.0000000000', '5000.0000000000', '2020-04-05 22:42:06', '2020-04-08 11:09:42');
INSERT INTO `tb_rawmaterial` VALUES ('50', '奶粉', null, null, '克', '0.0160000000', '15000.0000000000', '10000.0000000000', '40000.0000000000', '2020-04-06 22:53:28', '2020-04-06 22:53:28');
...
CREATE TABLE `tb_shopping_cart` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3661 DEFAULT CHARSET=utf8 COMMENT='购物车表';
...
CREATE TABLE `tb_sms_log` (
  ...
  `create_time` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=85 DEFAULT CHARSET=utf8 COMMENT='短信验证码记录表';
...
CREATE TABLE `tb_system_usage_record` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2103 DEFAULT CHARSET=utf8 COMMENT='系统使用记录表';
