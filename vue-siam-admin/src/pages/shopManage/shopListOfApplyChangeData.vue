<template>
	<section>
		...
		<el-table :data="list" highlight-current-row v-loading="listLoading" style="width: 100%;" :cell-style="cellStyle" :header-cell-style="headerCellStyle">
			...
			<el-table-column prop="rawShopName" label="门店名称"></el-table-column>
			...
			<el-table-column label="操作" fixed="right" width="230">
				<template slot-scope="scope">
					<el-button size="small" v-if="scope.row.auditStatus == 1" type="primary" @click="handleCheck(scope.row)">处理</el-button>
	...
	export default {
		...
		methods: {
			...
			getList(pageNoParam) { // 获取列表
				...
				param.auditStatus = -1; //查询审核中/审核不通过的记录
				...
				vue.$http.post(vue, '/api-merchant/rest/admin/shopChangeRecord/list', param,
					(vue, data) => {
			...
			checkEditSubmit: function () { // 编辑
				...
				let url = '/api-merchant/rest/admin/shopChangeRecord/audit';
