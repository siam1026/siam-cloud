	...
	export default {
		...
		methods: {
			...
			printOrderDetail() {				
				...
				//获取订单信息
				let vue = this
				vue.$http.post(vue, '/api-order/rest/admin/order/selectById', {"id" : id},
					(vue, data) => {
						let order = data.data;
						...
						//获取订单明细信息
						vue.$http.post(vue, '/api-order/rest/admin/orderDetail/list', {"pageNo" : -1, "pageSize" : 20, "orderId" : id},
							(vue, data) => {
			...
			getList(id) { // 获取商品列表
				...
				vue.$http.post(vue, '/api-order/rest/admin/orderDetail/list', param,
					(vue, data) => {
