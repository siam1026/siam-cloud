	...
	export default {
      ...
      handleCheck(row){
        ...
        let vue = this;
				...
				let url = '/api-order/rest/admin/order/auditAfterSalesOrder';
      ...
      dealOption() {
        ...
        vue.dealtype ? url = '/api-order/rest/admin/order/updateOrderByBack' : url = '/api-order/rest/admin/order/updateByDealadvise'
        vue.$http.post( vue, url, param,
          (vue, data) => {
            vue.$message({
              showClose: true,
      ...
      addStand() { // 新增规格
        ...
        vue.$http.post( vue, '/api-goods/rest/admin/stand/update', param,
          (vue, data) => {
            vue.$message({
              showClose: true,
              message: data.message,
      ...
      getList(pageNoParam) { // 获取列表
        ...
        vue.listLoading = true;
				vue.$http.post(vue, '/api-order/rest/admin/order/afterSalesList', param,
					(vue, data) => {
			...
			handleDel (id) { // 删除
				...
				let vue = this;
				vue.$http.post(vue, '/api-goods/rest/admin/stand/deleteById', {id},
					function(vue, data) {
            vue.$message({
              showClose: true,
              message: data.message,
        ...
        let param = {
          ...
          status: 1
				...
				vue.$http.post(vue, '/api-order/rest/admin/order/updateOrderState', param,
					function(vue, data) {
            vue.$message({
              showClose: true,
              message: data.message,
