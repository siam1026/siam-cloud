            ...
            get() {
                return {
                    ...
                    autoPrintOrderInfo() { // 获取订单列表      
                        ...
                        let vue = this
                        //查询所有已付款未打印的订单
                        $http.post(vue, '/api-order/rest/admin/order/waitPrintOrderList', {},
                            (vue, data) => {
                    ...
                    batchUpdateIsPrintedTrue(idList) { // 获取订单列表
                        ...
                        let vue = this
                        $http.post(vue, '/api-order/rest/admin/order/batchUpdateIsPrintedTrue', {"idListStr" : JSON.stringify(idList)},
                            (vue, data) => {
                                //修改成功
                            },(error, data)=> {
                                alert(data.message);
                    ...
                    printOrderDetail: function (id) {
                        ...
                        //获取订单信息
                        let vue = this
                        $http.post(vue, '/api-order/rest/admin/order/selectById', {"id" : id},
                            (vue, data) => {
                                let order = data.data;
                                //数据行
                                AData = '['+
                                ...
                                //获取订单明细信息
                                $http.post(vue, '/api-order/rest/admin/orderDetail/list', {"pageNo" : -1, "pageSize" : 20, "orderId" : id},
                                    (vue, data) => {
