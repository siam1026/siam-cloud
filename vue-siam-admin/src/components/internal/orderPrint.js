            ...
            get() {
                return {
                    ...
                    autoPrintOrderInfo() { // 获取订单列表      
                        ...
                        $.ajax({
                            type: "post",
                            url: urlPrefix + '/api-order/rest/admin/order/waitPrintOrderList',
                            async: false,
                            data: {},
                    ...
                    batchUpdateIsPrintedTrue(idList) { // 获取订单列表
                        ...
                        $.ajax({
                            type: "post",
                            url: urlPrefix + '/api-order/rest/admin/order/batchUpdateIsPrintedTrue',
                            async: false,
                    ...
                    printOrderDetail: function (id) {
                        ...
                        $.ajax({
                            type: "post",
                            url: urlPrefix + '/api-order/rest/admin/order/selectById',
                            async: false,
                            data: {"id" : id},
                            beforeSend: function(request) {
                                request.setRequestHeader("token", sessionStorage.getItem("token"));
                            ...
                            success: function(data){
                                ...
                                $.ajax({
                                    type: "post",
                                    url: urlPrefix + '/api-order/rest/admin/orderDetail/list',
                                    async: false,
